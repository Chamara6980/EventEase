...
<div class="container form-container">
    <h2 class="text-center mb-4 text-danger">Delete Event from Log Report</h2>
    <form action="logbookdelete" method="post" name="formDetails">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" placeholder="Event Venue" name="venue" value="<%= venue %>" readonly>
        </div>

        <div class="mb-3">
            <label for="date" class="form-label">Date:</label>
            <input type="text" class="form-control" placeholder="Date" name="Date" value="<%= Date %>" readonly>
        </div>

        <div class="mb-3">
            <label for="customerName" class="form-label">Customer Name:</label>
            <input type="text" class="form-control" placeholder="Customer Name" name="customerName" value="<%= customerName %>" readonly>
        </div>

        <div class="mb-3">
            <label for="rating" class="form-label">User Rating (0-5):</label>
            <input type="text" class="form-control" placeholder="0 - 5" name="rating" value="<%= rating %>" readonly>
        </div>

        <div class="text-center">
            <input type="submit" value="Delete this record" name="delete" class="btn btn-danger w-50">
        </div>
    </form>
</div>
