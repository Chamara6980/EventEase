		...
		<div class="row">
			<div class="col-md-4 mb-4">
				<div class="event-card">
					...
					<p>Join industry leaders for the most exciting technology
			...
			<div class="col-md-4 mb-4">
				<div class="event-card">
					...
					<p>Experience live performances from top artists at the most
						anticipated festival.</p>
					<a href="#" class="btn btn-primary">View Event</a>
				</div>
			</div>
			<div class="col-md-4 mb-4">
				<div class="event-card">
					...
					<p>Explore innovative artworks from renowned artists and
						upcoming talents.</p>
					<a href="#" class="btn btn-primary">View Event</a>
				</div>
			</div>
